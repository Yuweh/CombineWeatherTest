...
/* 1 */
/* 1
 Make WeeklyWeatherViewModel conform to ObservableObject and Identifiable. Conforming to these means that the WeeklyWeatherViewModel‘s properties can be used as bindings. You’ll see how to create them once you reach the View layer.]
 */
class WeeklyWeatherViewModel: ObservableObject, Identifiable {
  /* 2
   The properly delegate @Published modifier makes it possible to observe the city property. You’ll see in a moment how to leverage this.
   */
